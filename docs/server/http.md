...
<img :src="$withBase('/assets/server/05.png')" alt="05.png">
...
<img :src="$withBase('/assets/server/06.png')" alt="05.png">
...
<img :src="$withBase('/assets/server/async_time.png')" alt="async_time.png">
...
<img :src="$withBase('/assets/server/mysql01.png')" alt="mysql01.png">
...
<img :src="$withBase('/assets/server/php.png')" alt="php.png">
